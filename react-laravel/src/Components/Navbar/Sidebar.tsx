...
import { Inventory, Inventory2, SupportAgent } from '@mui/icons-material';
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <List>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/salesform")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Salesform" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
